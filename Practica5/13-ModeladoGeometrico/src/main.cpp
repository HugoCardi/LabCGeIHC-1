...
//perrito practica 4
//terminar modelo
//mover camara con las teclas : modificar matriz de vista
...
void applicationLoop() {
	...
	while (psi) {
		...
		//Matriz de la esfera uno.Se coloca -0.5 unidades en el eje y debajo del torso.
		...
		matrix7 = glm::translate(matrix7, glm::vec3(0.4f, 0.0f, 0.0f));
		matrix7 = glm::scale(matrix7, glm::vec3(0.8f, 0.15f, 0.15f));
		...
		matrix2 = glm::scale(matrix2, glm::vec3(0.125f, 0.6, 0.2f));
		cylinder.setProjectionMatrix(projection);
		cylinder.setViewMatrix(view);
		cylinder.enableWireMode();
