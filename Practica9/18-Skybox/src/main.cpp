//glew include
#include <GL/glew.h>
//descargar otra textura en 3D y practicar
//
//std includes
#include <string>
#include <iostream>
...
std::string fileNames[6] = { 
	"../../Textures/mp_lmcity/lmcity_ft.tga",
	"../../Textures/mp_lmcity/lmcity_bk.tga",
	"../../Textures/mp_lmcity/lmcity_up.tga",
	"../../Textures/mp_lmcity/lmcity_dn.tga",
	"../../Textures/mp_lmcity/lmcity_rt.tga",
	"../../Textures/mp_lmcity/lmcity_lf.tga"
};
...
void applicationLoop() {
	...
	while (psi) {
		...
		cylinder2.setPosition(glm::vec3(5,0,-5));
		cylinder2.render(0, cylinder.getSlices() * cylinder2.getStacks() * 2 * 3, cubeModelMatrix);
		glBindTexture(GL_TEXTURE_2D, textureID1);
		cylinder2.render(cylinder2.getSlices() * cylinder2.getStacks() * 2 * 3, cylinder2.getSlices() * 3, cubeModelMatrix);
		glBindTexture(GL_TEXTURE_2D, textureID3);
		cylinder2.render(cylinder2.getSlices() * cylinder2.getStacks() * 2 * 3 + cylinder2.getSlices() * 3, cylinder2.getSlices() * 3, cubeModelMatrix);
		glBindTexture(GL_TEXTURE_2D, 0);
		...
		sphere.setProjectionMatrix(projection);
		// PARA OBSERVAR EL SKYBOX , QUITAMOS EL VECTOR DE TRASLACION
		//sphere.setViewMatrix(view);
